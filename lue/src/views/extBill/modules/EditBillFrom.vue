    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="账单名称">
          <a-input
                  placeholder="请填写账单名称"
                  v-decorator="['display_name', { rules: [{ required: true, message: '账单名称不能为空！' }] }]"
                  @keyup.native.enter="ok"
          />
        </a-form-item>
        <a-form-item label="账单描述">
          <a-input
                  placeholder="请填写账单描述(非必填)"
